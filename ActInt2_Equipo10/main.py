...
file_lines = file_structure[1]  # Asumiendo que file_structure es una lista de líneas

# Problema 2 y 3: usar la primera línea para el problema del agente viajero y el árbol de expansión mínima
adj_matrix_1 = build_adjacency_matrix_from_file_lines(file_lines)
